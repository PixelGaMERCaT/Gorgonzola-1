 ...
 * @author GRIP
 */
public class RocketPipeline implements Pipeline {
	 ...
	 */
	public void hsvThreshold(Mat input, double[] hue, double[] sat, double[] val, Mat out) {
	 ...
	 */
	public void cvErode(Mat src, Mat kernel, Point anchor, double iterations, int borderType, Scalar borderValue,
			Mat dst) {
		if (kernel == null) {
			kernel = new Mat();
		}
	 ...
	 * @param output   The image in which to store the output.
	 */
	public void findContours(Mat input, boolean externalOnly, List<MatOfPoint> contours) {
	 ...
	 */
	public void filterContours(List<MatOfPoint> inputContours, double minArea, double minPerimeter, double minWidth,
	...
	public ArrayList<VisionTarget> getSupportedTargets() {
		ArrayList<VisionTarget> supported = new ArrayList<VisionTarget>();
		supported.add(VisionTarget.targets.get("RocketTarget"));
		return supported;
	}
